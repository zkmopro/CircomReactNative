...
#if canImport(circom_prover_bindingsFFI)
import circom_prover_bindingsFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_circom_prover_bindings_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_circom_prover_bindings_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureCircomProverBindingsInitialized()
...
public func circomProve(graphPath: String, inputs: String, zkeyPath: String)throws  -> CircomProofResult  {
    return try  FfiConverterTypeCircomProofResult_lift(try rustCallWithError(FfiConverterTypeMoproError_lift) {
    uniffi_circom_prover_bindings_fn_func_circom_prove(
...
public func circomVerify(proof: CircomProofResult, zkeyPath: String)throws  -> Bool  {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeMoproError_lift) {
    uniffi_circom_prover_bindings_fn_func_circom_verify(
        FfiConverterTypeCircomProofResult_lower(proof),
        FfiConverterString.lower(zkeyPath),$0
    )
})
}
public func generateCircomProof(zkeyPath: String, circuitInputs: String, proofLib: ProofLib)throws  -> CircomProofResult  {
    return try  FfiConverterTypeCircomProofResult_lift(try rustCallWithError(FfiConverterTypeMoproError_lift) {
    uniffi_circom_prover_bindings_fn_func_generate_circom_proof(
...
public func generateHalo2Proof(srsPath: String, pkPath: String, circuitInputs: [String: [String]])throws  -> Halo2ProofResult  {
    ...
    uniffi_circom_prover_bindings_fn_func_generate_halo2_proof(
...
public func generateNoirProof(circuitPath: String, srsPath: String?, inputs: [String], onChain: Bool, vk: Data, lowMemoryMode: Bool)throws  -> Data  {
    ...
    uniffi_circom_prover_bindings_fn_func_generate_noir_proof(
...
public func getNoirVerificationKey(circuitPath: String, srsPath: String?, onChain: Bool, lowMemoryMode: Bool)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeMoproError_lift) {
    uniffi_circom_prover_bindings_fn_func_get_noir_verification_key(
        FfiConverterString.lower(circuitPath),
        FfiConverterOptionString.lower(srsPath),
        FfiConverterBool.lower(onChain),
        FfiConverterBool.lower(lowMemoryMode),$0
...
public func moproHelloWorld() -> String  {
    ...
    uniffi_circom_prover_bindings_fn_func_mopro_hello_world($0
    )
})
}
public func verifyCircomProof(zkeyPath: String, proofResult: CircomProofResult, proofLib: ProofLib)throws  -> Bool  {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeMoproError_lift) {
    uniffi_circom_prover_bindings_fn_func_verify_circom_proof(
        FfiConverterString.lower(zkeyPath),
...
public func verifyHalo2Proof(srsPath: String, vkPath: String, proof: Data, publicInput: Data)throws  -> Bool  {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeMoproError_lift) {
    uniffi_circom_prover_bindings_fn_func_verify_halo2_proof(
        FfiConverterString.lower(srsPath),
...
public func verifyNoirProof(circuitPath: String, proof: Data, onChain: Bool, vk: Data, lowMemoryMode: Bool)throws  -> Bool  {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeMoproError_lift) {
    uniffi_circom_prover_bindings_fn_func_verify_noir_proof(
        FfiConverterString.lower(circuitPath),
        FfiConverterData.lower(proof),
        FfiConverterBool.lower(onChain),
        FfiConverterData.lower(vk),
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_circom_prover_bindings_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_circom_prover_bindings_checksum_func_circom_prove() != 17890) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_circom_prover_bindings_checksum_func_circom_verify() != 61109) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_circom_prover_bindings_checksum_func_generate_circom_proof() != 15868) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_circom_prover_bindings_checksum_func_generate_halo2_proof() != 17722) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_circom_prover_bindings_checksum_func_generate_noir_proof() != 50509) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_circom_prover_bindings_checksum_func_get_noir_verification_key() != 36855) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_circom_prover_bindings_checksum_func_mopro_hello_world() != 13068) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_circom_prover_bindings_checksum_func_verify_circom_proof() != 62347) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_circom_prover_bindings_checksum_func_verify_halo2_proof() != 26209) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_circom_prover_bindings_checksum_func_verify_noir_proof() != 18957) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureCircomProverBindingsInitialized() {
