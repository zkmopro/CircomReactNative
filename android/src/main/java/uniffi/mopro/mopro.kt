    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) =
            uniffiRustCall { status ->
                ...
                UniffiLib.INSTANCE.ffi_circom_prover_bindings_rustbuffer_alloc(size.toLong(), status)
            }.also {
                if (it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) =
            uniffiRustCall { status ->
                UniffiLib.INSTANCE.ffi_circom_prover_bindings_rustbuffer_free(buf, status)
            }
    }
...
internal interface IntegrityCheckingUniffiLib : Library {
    ...
    fun uniffi_circom_prover_bindings_checksum_func_circom_prove(): Short

    fun uniffi_circom_prover_bindings_checksum_func_circom_verify(): Short

    fun uniffi_circom_prover_bindings_checksum_func_generate_circom_proof(): Short

    fun uniffi_circom_prover_bindings_checksum_func_generate_halo2_proof(): Short

    fun uniffi_circom_prover_bindings_checksum_func_generate_noir_proof(): Short

    fun uniffi_circom_prover_bindings_checksum_func_get_noir_verification_key(): Short

    fun uniffi_circom_prover_bindings_checksum_func_mopro_hello_world(): Short

    fun uniffi_circom_prover_bindings_checksum_func_verify_circom_proof(): Short

    fun uniffi_circom_prover_bindings_checksum_func_verify_halo2_proof(): Short

    fun uniffi_circom_prover_bindings_checksum_func_verify_noir_proof(): Short

    fun ffi_circom_prover_bindings_uniffi_contract_version(): Int
}
...
internal interface UniffiLib : Library {
    companion object {
        internal val INSTANCE: UniffiLib by lazy {
            val componentName = "circom_prover_bindings"
            // For large crates we prevent `MethodTooLargeException` (see #2340)
            // N.B. the name of the extension is very misleading, since it is
            // rather `InterfaceTooLargeException`, caused by too many methods
            // in the interface for large crates.
    ...
    // FFI functions
    fun uniffi_circom_prover_bindings_fn_func_circom_prove(
        `graphPath`: RustBuffer.ByValue,
        `inputs`: RustBuffer.ByValue,
        `zkeyPath`: RustBuffer.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun uniffi_circom_prover_bindings_fn_func_circom_verify(
        `proof`: RustBuffer.ByValue,
        `zkeyPath`: RustBuffer.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): Byte

    fun uniffi_circom_prover_bindings_fn_func_generate_circom_proof(
        `zkeyPath`: RustBuffer.ByValue,
    ...
    fun uniffi_circom_prover_bindings_fn_func_generate_halo2_proof(
    ...
    fun uniffi_circom_prover_bindings_fn_func_generate_noir_proof(
    ...
    fun uniffi_circom_prover_bindings_fn_func_get_noir_verification_key(
        `circuitPath`: RustBuffer.ByValue,
        `srsPath`: RustBuffer.ByValue,
        `onChain`: Byte,
        `lowMemoryMode`: Byte,
    ...
    fun uniffi_circom_prover_bindings_fn_func_mopro_hello_world(uniffi_out_err: UniffiRustCallStatus): RustBuffer.ByValue

    fun uniffi_circom_prover_bindings_fn_func_verify_circom_proof(
        `zkeyPath`: RustBuffer.ByValue,
    ...
    fun uniffi_circom_prover_bindings_fn_func_verify_halo2_proof(
        `srsPath`: RustBuffer.ByValue,
    ...
    fun uniffi_circom_prover_bindings_fn_func_verify_noir_proof(
        `circuitPath`: RustBuffer.ByValue,
        `proof`: RustBuffer.ByValue,
        `onChain`: Byte,
        `vk`: RustBuffer.ByValue,
    ...
    fun ffi_circom_prover_bindings_rustbuffer_alloc(
        `size`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_circom_prover_bindings_rustbuffer_from_bytes(
        `bytes`: ForeignBytes.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_circom_prover_bindings_rustbuffer_free(
        `buf`: RustBuffer.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit

    fun ffi_circom_prover_bindings_rustbuffer_reserve(
        `buf`: RustBuffer.ByValue,
        `additional`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_circom_prover_bindings_rust_future_poll_u8(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_circom_prover_bindings_rust_future_cancel_u8(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_free_u8(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_complete_u8(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Byte

    fun ffi_circom_prover_bindings_rust_future_poll_i8(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_circom_prover_bindings_rust_future_cancel_i8(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_free_i8(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_complete_i8(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Byte

    fun ffi_circom_prover_bindings_rust_future_poll_u16(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_circom_prover_bindings_rust_future_cancel_u16(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_free_u16(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_complete_u16(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Short

    fun ffi_circom_prover_bindings_rust_future_poll_i16(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_circom_prover_bindings_rust_future_cancel_i16(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_free_i16(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_complete_i16(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Short

    fun ffi_circom_prover_bindings_rust_future_poll_u32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_circom_prover_bindings_rust_future_cancel_u32(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_free_u32(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_complete_u32(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Int

    fun ffi_circom_prover_bindings_rust_future_poll_i32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_circom_prover_bindings_rust_future_cancel_i32(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_free_i32(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_complete_i32(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Int

    fun ffi_circom_prover_bindings_rust_future_poll_u64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_circom_prover_bindings_rust_future_cancel_u64(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_free_u64(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_complete_u64(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Long

    fun ffi_circom_prover_bindings_rust_future_poll_i64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_circom_prover_bindings_rust_future_cancel_i64(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_free_i64(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_complete_i64(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Long

    fun ffi_circom_prover_bindings_rust_future_poll_f32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_circom_prover_bindings_rust_future_cancel_f32(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_free_f32(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_complete_f32(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Float

    fun ffi_circom_prover_bindings_rust_future_poll_f64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_circom_prover_bindings_rust_future_cancel_f64(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_free_f64(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_complete_f64(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Double

    fun ffi_circom_prover_bindings_rust_future_poll_pointer(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_circom_prover_bindings_rust_future_cancel_pointer(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_free_pointer(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_complete_pointer(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Pointer

    fun ffi_circom_prover_bindings_rust_future_poll_rust_buffer(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_circom_prover_bindings_rust_future_cancel_rust_buffer(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_free_rust_buffer(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_complete_rust_buffer(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_circom_prover_bindings_rust_future_poll_void(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_circom_prover_bindings_rust_future_cancel_void(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_free_void(`handle`: Long): Unit

    fun ffi_circom_prover_bindings_rust_future_complete_void(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit
}
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    if (lib.uniffi_circom_prover_bindings_checksum_func_circom_prove() != 17890.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_circom_prover_bindings_checksum_func_circom_verify() != 61109.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_circom_prover_bindings_checksum_func_generate_circom_proof() != 15868.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_circom_prover_bindings_checksum_func_generate_halo2_proof() != 17722.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_circom_prover_bindings_checksum_func_generate_noir_proof() != 50509.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_circom_prover_bindings_checksum_func_get_noir_verification_key() != 36855.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_circom_prover_bindings_checksum_func_mopro_hello_world() != 13068.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_circom_prover_bindings_checksum_func_verify_circom_proof() != 62347.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_circom_prover_bindings_checksum_func_verify_halo2_proof() != 26209.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_circom_prover_bindings_checksum_func_verify_noir_proof() != 18957.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
...
fun `circomProve`(
    `graphPath`: kotlin.String,
    `inputs`: kotlin.String,
    `zkeyPath`: kotlin.String,
): CircomProofResult =
    FfiConverterTypeCircomProofResult.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_circom_prover_bindings_fn_func_circom_prove(
                FfiConverterString.lower(`graphPath`),
                FfiConverterString.lower(`inputs`),
...
fun `circomVerify`(
    ...
    FfiConverterBoolean.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_circom_prover_bindings_fn_func_circom_verify(
                FfiConverterTypeCircomProofResult.lower(`proof`),
                FfiConverterString.lower(`zkeyPath`),
                _status,
            )
        },
...
fun `generateCircomProof`(
    ...
    FfiConverterTypeCircomProofResult.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_circom_prover_bindings_fn_func_generate_circom_proof(
                FfiConverterString.lower(`zkeyPath`),
...
fun `generateHalo2Proof`(
    ...
    FfiConverterTypeHalo2ProofResult.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_circom_prover_bindings_fn_func_generate_halo2_proof(
...
fun `generateNoirProof`(
    ...
    FfiConverterByteArray.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_circom_prover_bindings_fn_func_generate_noir_proof(
...
fun `getNoirVerificationKey`(
    ...
    FfiConverterByteArray.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_circom_prover_bindings_fn_func_get_noir_verification_key(
                FfiConverterString.lower(`circuitPath`),
                FfiConverterOptionalString.lower(`srsPath`),
                FfiConverterBoolean.lower(`onChain`),
                FfiConverterBoolean.lower(`lowMemoryMode`),
...
fun `moproHelloWorld`(): kotlin.String =
    FfiConverterString.lift(
        uniffiRustCall { _status ->
            UniffiLib.INSTANCE.uniffi_circom_prover_bindings_fn_func_mopro_hello_world(
                _status,
            )
        },
    )
...
fun `verifyCircomProof`(
    ...
    FfiConverterBoolean.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_circom_prover_bindings_fn_func_verify_circom_proof(
                FfiConverterString.lower(`zkeyPath`),
...
fun `verifyHalo2Proof`(
    ...
    FfiConverterBoolean.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_circom_prover_bindings_fn_func_verify_halo2_proof(
                FfiConverterString.lower(`srsPath`),
...
fun `verifyNoirProof`(
    ...
    FfiConverterBoolean.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_circom_prover_bindings_fn_func_verify_noir_proof(
                FfiConverterString.lower(`circuitPath`),
                FfiConverterByteArray.lower(`proof`),
                FfiConverterBoolean.lower(`onChain`),
                FfiConverterByteArray.lower(`vk`),
